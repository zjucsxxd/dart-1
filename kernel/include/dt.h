/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Codename Pegasus Operating System - Defines the GDT and IDT interface *
...
/* * * * * * * * * * * * * * * * * * * * * * * * *
 *  Allows the kernel stack in TSS to be changed * 
 * * * * * * * * * * * * * * * * * * * * * * * * */
void set_kernel_stack(u32int stack);

/* * * * * * * * * * * * * * * * * * * * * * * * *
 * A struct containing the value of the GDT entry*
 * The attribute 'packed' is used by us to tell  *
 * GCC not to change any of the alignment in the *
 *                   structure.                  *
 * * * * * * * * * * * * * * * * * * * * * * * * */
 ...
 *      It is in the format required by the      *
 *               lgdt instruction.               * 
 * * * * * * * * * * * * * * * * * * * * * * * * */
